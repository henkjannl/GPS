...
static void doSomeWork()
{
  ...
  if (fix.valid.location) 
    oled.print("Valid location       ");
  else
    oled.print("Location not fixed   ");

  oled.setRow(2);
  oled.setCol(0);
  oled.print("Lat: " + String(fix.latitude())+"   ");
  oled.print(fix.latitude());

  oled.setRow(3);
  oled.setCol(0);
  oled.print("Lon: " + String(fix.longitude())+"   ");

  oled.setRow(4);
  oled.setCol(0);
  oled.print("Satellites: " + String(fix.satellites)+"   ");
